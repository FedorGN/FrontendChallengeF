...
import { EmployeeBaseModel, EmployeeListModel, EmployeeModel } from "../models/employee.model";
...
export default class EmployeeService {
  ...
  public createEmployee(params: EmployeeBaseModel): Promise<EmployeeModel | undefined> {
